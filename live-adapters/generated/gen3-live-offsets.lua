...
return {
  oldUnownInternalStart = 0xfc,
  oldUnownInternalEnd = 0x114,
  oldUnownNational = 0xc9,
  internalToNational = {
    [1] = 1,
    [2] = 2,
    [3] = 3,
  ...
  profiles = {
    ruby_sapphire =     {
      ...
      activeParty = 0x03004360,
      saveBlock1Size = 0x3ac0,
      saveBlock2Size = 0x0f2c,
      pokemonStorageMode = "scan",
      pokemonStorageCandidates = { 0x020300a0, 0x0202fec0, 0x0202ff10, 0x0202f5b0, 0x02030870, 0x0202ec50, 0x02025d8c, 0x02025d88, 0x02025d90 },
      pokemonStorageSize = 0x83d0,
      ewramStart = 0x02000000,
      ewramEnd = 0x02040000,
      resolution = "fixed-saveblocks-plus-storage-scan",
      partyCountSize = 0x1,
      quantityMask = "none",
      pcBoxCount = 0xe,
      pcBoxCapacity = 0x1e,
      pcPokemonSize = 0x50,
      partyPokemonSize = 0x64,
      boxNameLength = 0x9,
      pockets = {
    {
      name = "PC Items",
    ...
    emerald =     {
      ...
      pokemonStoragePtr = 0x03005d94,
      activePartyCandidates = { 0x020244ec, 0x02024190 },
      ...
      ewramStart = 0x02000000,
      ewramEnd = 0x02040000,
      aslrMoveRange = 0x0080,
      resolution = "aslr-runtime-scan",
      partyCountSize = 0x1,
    ...
    fire_red_leaf_green =     {
      key = "fire_red_leaf_green",
      game = "firered",
      nationalMagic = 0xb9,
      eventFlagCount = 0x8c3,
      trainerName = 0x0000,
      trainerGender = 0x0008,
      trainerId = 0x000a,
      playTimeHours = 0x000e,
      ...
      pokemonStoragePtr = 0x03005010,
      activeParty = 0x02024284,
