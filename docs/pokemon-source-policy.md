...
- `lib/pokemon/data/pokemon-encounters.json`: generated from PokeAPI
  `location_area_encounters` data for National Dex 1-386 and supported Gen 1-3 version groups.
- `lib/pokemon/data/pokemon-learnsets.json`: generated from PokeAPI move version-group details for National Dex 1-386 and Gen 1-3 moves.
